          ...
          <div className="bg-gray-800 rounded-lg p-12 text-center">
            ...
            <p className="text-gray-400">
              {filter === 'all' 
                ...
                : `Keine ${filter === 'enabled' ? 'aktiven' : 'pausierten'} Kampagnen vorhanden.`}
            </p>
          </div>
        ) : (
                    ...
                    <tr key={campaign.campaignId} className="hover:bg-gray-750 transition">
                      ...
                      <td className="px-6 py-4">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          {campaign.state === 'ENABLED' ? '✓ Aktiv' : '⏸ Pausiert'}
                        </span>
                      </td>
                      ...
                      <td className="px-6 py-4 text-right">
                        <span className={`text-sm font-semibold ${
                          campaign.acos <= 20 ? 'text-green-400' : 
                          campaign.acos <= 30 ? 'text-yellow-400' : 
                          'text-red-400'
                        }`}>
